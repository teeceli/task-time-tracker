...
insert into ttt_task(id_project, task_name)values (4, 'Sencha Devcelopment');
...
insert into ttt_task_log (id_task, username, task_description, task_log_date,task_minutes) values(3,'jsmith','Completed preparation work for initial draft',now(), 90);
